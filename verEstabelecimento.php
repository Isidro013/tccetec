<?php 
	...
	$sql = "SELECT nome, endereco, infos, bomsaber, acessibilidade, acessibilidade2, acessibilidade3, bomsaber2, bomsaber3, infos2, infos3, infos4, infos5, infos6 FROM projetodefi.hoteiscpv where id=$id";
...
<head>
	...
	<link rel="stylesheet" type="text/css" href="assets/css/css4.css">
</head>
	...
	<div class="row">
		<div class="col-sm-12 col-xm-12">
			...
			<li class="breadcrumb-item">
				...
				<a href="listahotelcpv.php"><li class="breadcrumb-item active" aria-current="page">Hotéis Caçapava</a></li>
...
<div class="container" id="bomsaber">
	<div class="row">
		...
		<div class="col-sm-8 col-xm-12">
			...
			<img src="img/pet.png" width=30 height=30>   <?php echo utf8_encode($bomsaber3);?><br><br>
			<th>
